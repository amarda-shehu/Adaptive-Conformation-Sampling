...
if pop.min_ca_rmsd < min_ca_rmsd:
    ...
    # print(min_ca_rmsd, score4_function(pop.min_ca_rmsd_pose))
...
while eval_budget > 0:
    ...
    for parent in parents:
        ...
        # print(pose_ca_rmsd, score4_energy)
...
if improvement.min_ca_rmsd < min_ca_rmsd:
    ...
    # print(min_ca_rmsd, score4_function(improvement.min_ca_rmsd_pose))
    f2.write("%s %s\n" % (
